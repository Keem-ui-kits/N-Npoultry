    ...
    <PageWrapper>
      <div className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto min-h-screen">
        ...
        <div className="prose prose-invert prose-brand prose-lg max-w-none text-white/80 font-light">
          ...
          <h3 className="text-2xl text-white font-bold mt-12 mb-4">Who we are and how to contact us</h3>
          ...
          <h3 className="text-2xl text-white font-bold mt-12 mb-4">By using our site you accept these terms</h3>
          ...
          <h3 className="text-2xl text-white font-bold mt-12 mb-4">There are other terms that may apply to you</h3>
          ...
          <h3 className="text-2xl text-white font-bold mt-12 mb-4">We may make changes to these terms</h3>
          ...
          <h3 className="text-2xl text-white font-bold mt-12 mb-4">We may make changes to our site</h3>
          ...
          <h3 className="text-2xl text-white font-bold mt-12 mb-4">We may suspend or withdraw our site</h3>
          ...
          <h3 className="text-2xl text-white font-bold mt-12 mb-4">Responsibility for others</h3>
          ...
          <h3 className="text-2xl text-white font-bold mt-12 mb-4">How you may use material on our site</h3>
          ...
          <h3 className="text-2xl text-white font-bold mt-12 mb-4">No text or data mining, or web scraping</h3>
          ...
          <h3 className="text-2xl text-white font-bold mt-12 mb-4">Do not rely on information on this site</h3>
          ...
          <h3 className="text-2xl text-white font-bold mt-12 mb-4">We are not responsible for websites we link to</h3>
          ...
          <h3 className="text-2xl text-white font-bold mt-12 mb-4">Our responsibility for loss or damage suffered by you</h3>
          ...
          <h3 className="text-2xl text-white font-bold mt-12 mb-4">Viruses</h3>
          ...
          <h3 className="text-2xl text-white font-bold mt-12 mb-4">Which country&apos;s laws apply to any disputes?</h3>
